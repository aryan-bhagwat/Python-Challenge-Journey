...
## Example 1: Convert a List to Dictionary
...
## Example 2: Add Conditional Logic
nums = range(1, 6)
even_squares = {x: x**2 for x in nums if x % 2 == 0}
print(even_squares)  # Output: {2: 4, 4: 16}

## Advanced Use: String Counter
word = "banana"
...
# 1. Create a dictionary with numbers as keys and their cubes as values from 1 to 5.
cube = {x : x**3 for x in range(1,6)}
print(cube)

# 2. Build a dictionary of student names and their lengths.
...
# 2. From a dictionary of student marks: Create a new dict with only students who passed (marks >= 60).
